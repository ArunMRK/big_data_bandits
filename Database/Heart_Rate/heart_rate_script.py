        ...
        Message={
            'Body': {
                'Html': {
                    ...
                    <br>
On <b>{user_alert_data["date"]}</b>, a user named <b>{user_alert_data["first"]} {user_alert_data["second"]}</b> aged <b>{user_alert_data["age"]}</b>, exceeded their maximum working heart rate (<b>{user_alert_data["max_heart_rate"]} bpm</b>) with a maximum reading of <b>{user_alert_data["user_heart_rate"]} bpm for 5 consecutive logs</b>. <br>
<br>
