...
def update_rides_per_gender(interval) -> list:
    ...
    return [dcc.Graph(figure=rides_per_gender_fig,  style={"text-align": "center",
                                                           "font-size": "10px"})]
...
def update_duration_per_gender(interval) -> list:
    ...
    return [dcc.Graph(figure=duration_per_gender_fig, style={"text-align": "center",
                                                             "font-size": "10px"})]
